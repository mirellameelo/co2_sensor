...
#define SWITCH_PIN 23 // it marks the begining of measumentsA

#define Fan 13 //fan pin on board
...
void setup() {
  ...
  //config. pin for fan functionality
  pinMode(Fan, OUTPUT);
}
...
void fanStatus(unsigned long CO2){
  if (CO2>800){
